#!/bin/bash
# Script to run BiQwen3-0.6B-0.30_lr1.07721735e-04 evaluation on selected tasks
...
export MODEL_PATH=/lustre/fswork/projects/rech/vrl/uok92vw/huggingface_models/BiQwen3-0.6B-0.30_lr1.07721735e-04
...
echo "========================================="
echo "Starting BiQwen3-0.6B-0.30_lr1.07721735e-04 Evaluation"
...
echo ""
echo "========================================="
echo "BiQwen3-0.6B-0.30_lr1.07721735e-04 Evaluation Complete"
echo "========================================="
